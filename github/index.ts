...
function useShareUrl() {
  return isMock() ? "https://dev.openecon.ai" : "https://openecon.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.openecon.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.openecon.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
