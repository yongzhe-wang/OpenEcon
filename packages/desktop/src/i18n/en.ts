export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenEcon Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenEcon CLI binary is missing. Try reinstalling the desktop app.",
