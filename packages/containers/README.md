...
```
REGISTRY=ghcr.io/openecon TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/openecon TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/openecon/build/bun-node:24.04
```
