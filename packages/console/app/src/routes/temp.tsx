    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <footer data-component="footer">
          ...
          <div data-slot="cell">
            <a href="https://github.com/openecon/opencode">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://openecon.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
      ...
      <div data-component="legal">
        <span>
          ©2025 <a href="https://openecon.ai">Anomaly</a>
        </span>
      </div>
    </main>
  )
