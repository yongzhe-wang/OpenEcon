...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "OpenEcon Desktop.dmg",
  "darwin-x64-dmg": "OpenEcon Desktop.dmg",
  "windows-x64-nsis": "OpenEcon Desktop Installer.exe",
...
export async function GET({ params: { platform, channel } }: APIEvent) {
  ...
  const resp = await fetch(
    `https://github.com/openecon/${channel === "stable" ? "opencode" : "opencode-beta"}/releases/latest/download/${assetName}`,
    {
      cf: {
