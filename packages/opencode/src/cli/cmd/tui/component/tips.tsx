...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at openecon.ai",
  ...
  "OpenEcon auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "OpenEcon auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "OpenEcon uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent OpenEcon from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode serve{/highlight} for headless API access to OpenEcon",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/openecon/opencode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with OpenEcon Zen for curated, tested models",
