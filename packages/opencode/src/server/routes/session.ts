  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenEcon sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenEcon session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenEcon session for interacting with AI assistants and managing conversations.",
