...
1. Run the `/connect` command in the TUI, select `OpenCode Zen`, and head to [openecon.ai/auth](https://openecon.ai/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCode Go`, and head to [openecon.ai/auth](https://openecon.ai/zen).
