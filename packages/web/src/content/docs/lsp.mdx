---
title: LSP Servers
description: OpenEcon integrates with your LSP servers.
---

OpenEcon integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

OpenEcon comes with several built-in LSP servers for popular languages:
