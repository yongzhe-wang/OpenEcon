...
Agent skills let OpenEcon discover reusable instructions from your repo or home directory.
...
OpenEcon searches these locations:
...
For project-local paths, OpenEcon walks up from your current working directory until it reaches the git worktree.
...
OpenEcon lists available skills in the `skill` tool description.
