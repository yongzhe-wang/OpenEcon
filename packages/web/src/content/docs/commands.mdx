...
You can add custom commands through the OpenEcon config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenEcon [config](/docs/config):
