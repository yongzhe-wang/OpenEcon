---
title: Share
description: Share your OpenEcon conversations.
---

OpenEcon's share feature allows you to create public links to your OpenEcon conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, OpenEcon:
...
OpenEcon supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, OpenEcon uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
