...
OpenEcon Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

:::note
OpenEcon Go is currently in beta.
:::

Go works like any other provider in OpenEcon. You subscribe to OpenEcon Go and
...
OpenEcon Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

OpenEcon Go works like any other provider in OpenEcon.

1. You sign in to **<a href={console}>OpenEcon Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `OpenEcon Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to OpenEcon Go.
:::
...
OpenEcon Go includes the following limits:
...
| ------------ | ------------ | ------------------------------------------------ | --------------------------- |
| GLM-5        | glm-5        | `https://openecon.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5    | kimi-k2.5    | `https://openecon.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M2.7 | minimax-m2.7 | `https://openecon.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5 | minimax-m2.5 | `https://openecon.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
...
4. Have **no lock-in** by allowing you to use any other provider with OpenEcon as well.
