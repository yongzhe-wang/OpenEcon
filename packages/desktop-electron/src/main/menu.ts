...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "OpenEcon Documentation", click: () => shell.openExternal("https://openecon.ai/docs") },
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/openecon/opencode/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/openecon/opencode/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
