export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenEcon",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenEcon er lastet ned. Vil du installere den og starte på nytt?",
