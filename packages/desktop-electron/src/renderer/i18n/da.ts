export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenEcon",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenEcon er blevet downloadet. Vil du installere den og genstarte?",
