export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenEcon",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenEcon. Czy chcesz ją zainstalować i uruchomić ponownie?",
