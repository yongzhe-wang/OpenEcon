export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenEcon",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenEcon a été téléchargée. Voulez-vous l'installer et redémarrer ?",
